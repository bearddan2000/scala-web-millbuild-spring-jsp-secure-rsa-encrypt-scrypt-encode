...
<head>
    ...
    <title>Spring Boot JSP Security Example</title>
      ...
      <div class="container">
          ...
          <div id="navbar" class="collapse navbar-collapse">
              <ul class="nav navbar-nav">
                  ...
                  <li class="active"><a href="/super">Super</a></li>
...
<div class="container">
  <button type="button" class="btn btn-primary" id="create">Add row</button>
...
<script src="js/super.js" charset="utf-8"></script>
</body>
</html>
